...
namespace Kerekes_Denisa_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Kerekes_Denisa_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Kerekes_Denisa_Lab8Context context,
